...
write.table(ag,'/home/wus/2023_3_19-009-cxl_RNA/11-3_GWCNA-RRA/RRA_6KR_1WT_up-v2.txt',sep='\t')
...
write.table(ag,'/home/wus/2023_3_19-009-cxl_RNA/11-3_GWCNA-RRA/RRA_6KR_1WT_dw-v2.txt',sep='\t')


aa<-merge(ag,freq_dw,by.x='Name',by.y='Var1')
write.table(aa,'/home/wus/2023_3_19-009-cxl_RNA/11-3_GWCNA-RRA/RRA_6KR_1WT_dw-v3.txt',sep='\t')
