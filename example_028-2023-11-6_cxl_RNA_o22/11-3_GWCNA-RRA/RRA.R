...
flist<-c('condition_E64_vs_WT.txt','condition_E32_vs_WT.txt','condition_E258_vs_WT.txt','condition_E232_vs_WT.txt','condition_A65_vs_WT.txt','condition_A299_vs_WT.txt','condition_A120_vs_WT.txt')
...
write.table(ag,'RRA_7mut_1WT_up.txt',sep='\t')
...
write.table(ag,'RRA_7mut_1WT_dw.txt',sep='\t')