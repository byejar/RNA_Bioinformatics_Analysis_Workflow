...
df<-read.table('/scratch/wus/028-2023-11-6_cxl_RNA_o22/8_DEseq2/condition_E258_vs_WT.txt',sep='')
...
as.factor(grouP <- c(rep("A120",4), rep("A299",4), rep("A65",4), rep("E232",4), rep("E258",4), rep("E32",4),rep("E64",4), rep("WT",4)) )
desigN <- model.matrix(~ grouP + 0)
rownames(desigN) <- c("m_A120_1","m_A120_2","m_A120_3","m_A120_4","m_A299_1","m_A299_2","m_A299_3","m_A299_4","m_A65_1","m_A65_2","m_A65_3","m_A65_4","m_E232_1","m_E232_2","m_E232_3","m_E232_4","m_E258_1","m_E258_2","m_E258_3","m_E258_4","m_E32_1","m_E32_2","m_E32_3","m_E32_4","m_E64_1","m_E64_2","m_E64_3","m_E64_4","m_WT_1","m_WT_2","m_WT_3","m_WT_4")
desigN
...
write.csv(names(datExpr)[moduleColors=="blue"],'/scratch/wus/028-2023-11-6_cxl_RNA_o22/10_analysis/blue.csv')

names(datExpr)[moduleColors=="yellow"]
write.csv(names(datExpr)[moduleColors=="yellow"],'/scratch/wus/028-2023-11-6_cxl_RNA_o22/10_analysis/yellow.csv')
